...
- `staff-featured-toggle` — inline feature/un-feature toggle in the staff games list + 3-slot-cap replace-picker modal — added 2026-05-31 — `implemented` (full version incl. `featuredAt`/`featuredBy` migration; `FeaturedReplaceModal.vue` + feature/unfeature endpoints)
